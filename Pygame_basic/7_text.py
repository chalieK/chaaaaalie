...
# 적 enemy 캐릭터 
enemy = pygame.image.load("C:/Users/user/Desktop/py_workspace/Pygame_basic/enemy.png")
...
# 20 fps : 1초 동안 20번 동작 -> 1번에 5만큼 이동 5*20 = 200

    # print("fps : "+ str(clock.get_fps())) # fps확인
    
    for event in pygame.event.get(): # 어떤 이벤트가 발생 하는지 확인
    ...
    # 타이머 집어 넣기
    # 경과 시간 계산
    elapsed_time = (pygame.time.get_ticks() - start_ticks) / 1000 # 경과 시간(ms)을 1000으로 나누어서 초로 환산

    timer = game_font.render(str(int(total_time - elapsed_time)), True, (255, 255, 255))
    # 출력할 글자 및 시간 정보, true, 글자 색상
